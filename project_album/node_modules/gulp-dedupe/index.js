...
var through = require('gulp-dedupe/node_modules/gulp-dedupe/node_modules/through');
var gutil = require('gulp-dedupe/node_modules/gulp-dedupe/node_modules/gulp-util');
var PluginError = gutil.PluginError;
var path = require('path');
var defaults = require('gulp-dedupe/node_modules/gulp-dedupe/node_modules/lodash.defaults');
    ...
    function bufferContents(file) {
        ...
        if ((f = filesMap[fullpath])) {
            if (options.error) {
                ...
                if (options.diff) {
                    require('gulp-dedupe/node_modules/gulp-dedupe/node_modules/colors');
                    var diff = require('gulp-dedupe/node_modules/gulp-dedupe/node_modules/diff').diffChars(file.contents.toString(), f.contents.toString());
